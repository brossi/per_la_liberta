...
The companion is illustrated with **public-domain images** — period portraits, engravings, lithographs, and early photographs, preferred over modern ones to match the book's own era. Each is tied to a specific entry, and the same sourcing discipline applies to pictures as to prose: every image is a verified public-domain work, and its captions are honest about what it is — an actual likeness or site versus a *contemporary depiction* of an event (a representation, not a photograph of the moment). Where no authentic, cleanly licensed image of a subject exists — Calvi, the author Crespi, di Rudio's wife Elisa, the named ships — the entry is left unillustrated rather than given a misrepresented stand-in. Full provenance for every image, including holding institution, source page, and the observed rights statement, is recorded in [images/CREDITS.md](images/CREDITS.md).
