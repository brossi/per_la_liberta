...
*Per la libertà!* is not neutral history but a **partisan memoir** — di Rudio was a lifelong Mazzinian republican, fiercely anticlerical and hostile to the House of Savoy, and Crespi reproduces his voice deliberately. Its heroes (Mazzini, Calvi, Orsini) and villains (Napoleon III, Pius IX, the "practical" monarchy) are *the book's*, and these pages present them as the memoir sees them, citable to the chapters where they appear.

Where the companion adds **external context** — a date, an outcome, or a point where the historical record differs from di Rudio's account — it is set off in a marked **Historical note** callout; the [Event Context](events.md) pages add a second voice, **Scholarship**, drawing on the standard academic literature. Both keep the memoir's first-person telling visibly distinct from the historical record. It is also where the companion can say what the book itself cannot — above all, that di Rudio's story did not end where the memoir does, in 1864:
