...
The book-attributed content in these companions was assembled from a chapter-by-chapter reading pass over the English translation, and is **spot-verified** against the source text where a date or detail is load-bearing — not exhaustively re-checked line by line. External facts in **Historical note** callouts are confirmed against the cited source before being stated; a callout cites only sources actually consulted. Where the record is uncertain, or the book disagrees with itself or with the historical record, the text says so.
