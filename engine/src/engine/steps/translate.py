"""translate step — scaffold stub.

Ported from the top-level ``translate.py`` in M4c. The real signature is
...
def run(*args, **kwargs):
    raise NotImplementedError(
        "engine.steps.translate.run is an M0 scaffold stub; ported in M4c."
    )
