"""cleanup step — scaffold stub.

Ported from the top-level ``cleanup.py`` in M4b. The real signature is
...
def run(*args, **kwargs):
    raise NotImplementedError(
        "engine.steps.cleanup.run is an M0 scaffold stub; ported in M4b."
    )
