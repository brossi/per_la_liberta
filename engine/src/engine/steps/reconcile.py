"""reconcile step — scaffold stub.

Ported from the top-level ``reconcile.py`` in M3. The real signature is
...
def run(*args, **kwargs):
    raise NotImplementedError(
        "engine.steps.reconcile.run is an M0 scaffold stub; ported in M3."
    )
