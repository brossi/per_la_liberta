...
def generate_html(
    ...
    html_parts = [
        ...
        *_theme_controls_block(),
        ...
        '    <a class="toc-footer-companion" href="companion/index.html">Reader\'s Companion &#8594;</a>',
        '    <a class="toc-footer-colophon" href="#colophon">Colophon</a>',
        '    <p class="toc-footer-meta">&copy; 2026 Ben Rossi &middot; 1913 text in the public domain</p>',
        '  </div>',
        '</nav>',
    ...
    html_parts.extend([
        ...
        "  });",
        "",
        "  // Colophon + Reader's Companion live in the pinned panel footer (static",
        "  // markup), so they stay visible and clear of the browser's bottom hover",
        "  // overlay. The in-page Colophon anchor closes the panel on click.",
        "  const colophonLink = document.querySelector('.toc-footer-colophon');",
        "  if (colophonLink) colophonLink.addEventListener('click', () => { panel.classList.remove('open'); backdrop.classList.remove('open'); });",
        "",
